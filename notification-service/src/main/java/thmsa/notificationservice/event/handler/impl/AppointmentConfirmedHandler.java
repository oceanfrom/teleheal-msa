...
@Component
@Slf4j
public class AppointmentConfirmedHandler implements AppointmentEventHandler {

    @Value("${appointment.event.type.confirmed}")
    private String eventType;

    @Override
    public void handle(AppointmentEvent appointmentEvent) {
        log.info("Appointment confirmed, {}", appointmentEvent.appointmentId());
    }
